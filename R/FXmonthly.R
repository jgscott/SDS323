...
## PCA 
fxpca = prcomp(FXmonthly_ret, rank=5, scale=TRUE)
summary(fxpca)
plot(fxpca)
...
# in this case, not super informative
# would need to know more about the actual months in question
...
plot(fx_scores[,1], type='l')
plot(fx_scores[,2], type='l')
