...
- Astronomy: crunch enormous databases of sky surveys to find anomalie.   
...
- Neuroscience: build next-gen prostheses based on statistical decoding of neural signals upstream of an amputed limb  
...
R has flaws, but so do all options (e.g. Python is great but has downsides too, especially for interative data analysis).  
