...
This is almost certainly a good bet!
...
Key insight: _frame the problem in terms of conditional probability._
- Suppose we learn that you liked film $B$, but haven't yet seen film $A$.  
- What is $P(\mbox{likes A} \mid \mbox{likes B})$?  _Conditional probabilities hold the key to understanding individualized preferences._
- So how can we learn $P(\mbox{likes A} \mid \mbox{likes B})$?    
...
- It fills our jails, drains public finances, and perpetuates a trans-generational cycle of poverty.  
